...
class ExportarObraArte(QgsProcessingAlgorithm):
    ...
    INPUT = 'INPUT'
    VALOR_TIPO_OBRA_ARTE = 'VALOR_TIPO_OBRA_ARTE'
    ...
    def initAlgorithm(self, config=None):
        ...
        self.vtoa_keys, self.vtoa_values = get_lista_codigos('valorTipoObraArte')
        self.addParameter(
            QgsProcessingParameterEnum(
                self.VALOR_TIPO_OBRA_ARTE,
                self.tr('Valor Tipo Obra Arte'),
                self.vtoa_keys,
                defaultValue=0,
                optional=False,
            )
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        valor_tipo_obra_arte = self.vtoa_values[
        ...
        alg_params = {
            'FIELDS_MAPPING': [{
                ...
                'expression': valor_tipo_obra_arte,
                'length': 255,
                'name': 'valor_tipo_obra_arte',
                'precision': -1,
                'type': 10
            }],
    ...
    def name(self):
        return 'exportar_obra_arte'

    def displayName(self):
        return '18. Exportar Obra de arte'

    def group(self):
        return '05 - Transportes (Obra De Arte)'

    def groupId(self):
        return '05TransporteObraArte'

    def createInstance(self):
        return ExportarObraArte()
    ...
    def shortHelpString(self):
        return self.tr("Exporta elementos do tipo Obra de arte para a base " \
