...
class ExportarAreaInfraTransAereo(QgsProcessingAlgorithm):
    ...
    INPUT = 'INPUT'
    VALOR_TIPO_AREA_INFRA_TRANS_AEREO = 'VALOR_TIPO_AREA_INFRA_TRANS_AEREO'
    ...
    def initAlgorithm(self, config=None):
        ...
        self.vtaita_keys, self.vtaita_values = get_lista_codigos('valorTipoAreaInfraTransAereo')
        self.addParameter(
            QgsProcessingParameterEnum(
                self.VALOR_TIPO_AREA_INFRA_TRANS_AEREO,
                self.tr('Valor Tipo Area Infra Trans Aereo'),
                self.vtaita_keys,
                defaultValue=0,
                optional=False,
            )
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        valor_tipo_area_infra_trans_aereo = self.vtaita_values[
        ...
        alg_params = {
            'FIELDS_MAPPING': [{
                ...
                'expression': valor_tipo_area_infra_trans_aereo,
                'length': 255,
                'name': 'valor_tipo_area_infra_trans_aereo',
                'precision': -1,
                'type': 10
            }],
    ...
    def name(self):
        return 'exportar_area_infra_trans_aereo'

    def displayName(self):
        return '01. Exportar Área Infraestrutura Transporte Aéreo'
    ...
    def createInstance(self):
        return ExportarAreaInfraTransAereo()
    ...
    def shortHelpString(self):
        return self.tr("Exporta elementos do tipo Area Infra Trans Aereo para a base " \
