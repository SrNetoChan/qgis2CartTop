...
class ExportarAreaInfraTransCabo(QgsProcessingAlgorithm):
    ...
    def name(self):
        return 'exportar_area_infra_trans_cabo'

    def displayName(self):
        return '08. Exportar Área da infraestrutura de transporte por cabo'

    def group(self):
        return '05 - Transportes (Transporte Por Cabo)'

    def groupId(self):
        return '05TransportesPorCabo'

    def createInstance(self):
        return ExportarAreaInfraTransCabo()
    ...
    def shortHelpString(self):
        return self.tr("Exporta elementos do tipo Área da infraestrutura de transporte por cabo para a base " \
