...
class CriarNosRodoviarios(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(QgsProcessingParameterVectorLayer('segmentovia', 'Segmento de via rodoviária', types=[QgsProcessing.TypeVectorLine], defaultValue=None))
        self.addParameter(QgsProcessingParameterFeatureSink('NsTransporteRodovirio', 'Nós transporte rodoviário', type=QgsProcessing.TypeVectorAnyGeometry, createByDefault=True, supportsAppend=True, defaultValue=None))
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        alg_params = {
            ...
            'OUTPUT': parameters['NsTransporteRodovirio']
        }
        outputs['RefactorFields'] = processing.run('native:refactorfields', alg_params, context=context, feedback=feedback, is_child_algorithm=True)
        results['NsTransporteRodovirio'] = outputs['RefactorFields']['OUTPUT']

        context.layerToLoadOnCompletionDetails(results['NsTransporteRodovirio']).name = "Nós Rodoviários"
        return results

    def name(self):
        return 'criar_nos_rodoviarios'

    def displayName(self):
        return '14. Criar nós rodoviários'
    ...
    def shortHelpString(self):
        return self.tr("Cria camada de nós de transporte rodoviário com base " \
                        "numa camada de segmentos de via. \n\n Usando o número de " \
