...
class ExportarNascente(QgsProcessingAlgorithm):
    ...
    def name(self):
        return 'exportar_nascente'

    def displayName(self):
        return '07. Exportar Nascente'
    ...
    def shortHelpString(self):
        return self.tr("Exporta elementos do tipo Nascente para a base " \
