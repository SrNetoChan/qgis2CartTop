...
class Consolidar_curvas_de_nivel(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        sql_path = os.path.join(script_path, 'consolidar_curvas_de_nivel.sql')
        ...
        if substituir_backup:
            ...
            alg_params = {
                ...
                'SQL': 'DROP TABLE IF EXISTS backup.curva_de_nivel_bk;'
            }
    ...
    def displayName(self):
        return 'Consolidar curvas de nível'
    ...
    def shortHelpString(self):
        return self.tr(
            ...
            "<b>ATENÇÃO: Altera directamente a tabela curva_de_nivel<\b>"
                       )
