...
class ExportarQuedaDeAgua(QgsProcessingAlgorithm):
    ...
    def name(self):
        return 'exportar_queda_de_agua'

    def displayName(self):
        return '09. Exportar Queda de Água'
    ...
    def shortHelpString(self):
        return self.tr("Exporta elementos do tipo Queda De Agua para a base " \
