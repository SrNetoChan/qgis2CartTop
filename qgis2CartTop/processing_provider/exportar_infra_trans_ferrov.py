...
class ExportarInfraTransFerrov(QgsProcessingAlgorithm):
    ...
    INPUT = 'INPUT'
    VALOR_TIPO_INFRA_TRANS_FERROV = 'VALOR_TIPO_INFRA_TRANS_FERROV'
    ...
    def initAlgorithm(self, config=None):
        ...
        self.vtitf_keys, self.vtitf_values = get_lista_codigos('valorTipoInfraTransFerrov')
        self.addParameter(
            QgsProcessingParameterEnum(
                self.VALOR_TIPO_INFRA_TRANS_FERROV,
                self.tr('Valor Tipo Infra Trans Ferrov'),
                self.vtitf_keys,
                defaultValue=0,
                optional=False,
            )
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        valor_tipo_infra_trans_ferrov = self.vtitf_values[
        ...
        alg_params = {
            'FIELDS_MAPPING': [{
                ...
                'expression': valor_tipo_infra_trans_ferrov,
                'length': 255,
                'name': 'valor_tipo_infra_trans_ferrov',
                'precision': -1,
                'type': 10
            }],
    ...
    def name(self):
        return 'exportar_infra_trans_ferrov'

    def displayName(self):
        return '02. Exportar Infra Trans Ferrov'

    def group(self):
        return '04 - Transportes (Transporte Ferroviário)'

    def groupId(self):
        return '05TransporteFerroviario'

    def createInstance(self):
        return ExportarInfraTransFerrov()
    ...
    def shortHelpString(self):
        return self.tr("Exporta elementos do tipo Infra Trans Ferrov para a base " \
