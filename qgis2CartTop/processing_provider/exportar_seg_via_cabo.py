...
class ExportarSegViaCabo(QgsProcessingAlgorithm):
    ...
    def name(self):
        return 'exportar_seg_via_cabo'

    def displayName(self):
        return '09. Exportar Segmento da via por cabo'
    ...
    def shortHelpString(self):
        return self.tr("Exporta elementos do tipo Segmento da via por cabo para a base " \
