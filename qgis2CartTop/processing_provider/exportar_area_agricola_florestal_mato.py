...
class ExportarAreaAgricolaFlorestalMato(QgsProcessingAlgorithm):
    ...
    INPUT = 'INPUT'
    VALOR_AREAS_AGRICOLAS_FLORESTAIS_MATOS = 'VALOR_AREAS_AGRICOLAS_FLORESTAIS_MATOS'
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(
            QgsProcessingParameterEnum(
                ...
                self.tr('Valor Areas Agricolas Florestais Matos'),
                self.vaafm_keys,
                defaultValue=0,
                optional=False,
            )
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        valor_areas_agricolas_florestais_matos = self.vaafm_values[
    ...
    def name(self):
        return 'exportar_area_agricola_florestal_mato'

    def displayName(self):
        return '01. Exportar Área agrícola, florestal ou mato'

    def group(self):
        return '07 - Ocupação Do Solo'

    def groupId(self):
        return '07OcupacaoDoSolo'

    def createInstance(self):
        return ExportarAreaAgricolaFlorestalMato()
    ...
    def shortHelpString(self):
        return self.tr("Exporta elementos do tipo Área agrícola, florestal ou mato para a base " \
