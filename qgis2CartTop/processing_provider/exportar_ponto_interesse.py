...
class ExportarPontoInteresse(QgsProcessingAlgorithm):
    ...
    INPUT = 'INPUT'
    VALOR_TIPO_PONTO_INTERESSE = 'VALOR_TIPO_PONTO_INTERESSE'
    ...
    def initAlgorithm(self, config=None):
        ...
        self.vtpi_keys, self.vtpi_values = get_lista_codigos('valorTipoPontoInteresse')
        self.addParameter(
            QgsProcessingParameterEnum(
                self.VALOR_TIPO_PONTO_INTERESSE,
                self.tr('Valor Tipo Ponto Interesse'),
                self.vtpi_keys,
                defaultValue=0,
                optional=False,
            )
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        valor_tipo_ponto_interesse = self.vtpi_values[
        ...
        alg_params = {
            'FIELDS_MAPPING': [{
                ...
                'expression': valor_tipo_ponto_interesse,
                'length': 255,
                'name': 'valor_tipo_ponto_interesse',
                'precision': -1,
                'type': 10
            }],
    ...
    def name(self):
        return 'exportar_ponto_interesse'

    def displayName(self):
        return '04. Exportar Ponto de interesse'
    ...
    def shortHelpString(self):
        return self.tr("Exporta elementos do tipo Ponto de interesse para a base " \
