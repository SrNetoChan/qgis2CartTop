...
class ExportarInfraTransRodov(QgsProcessingAlgorithm):
    ...
    INPUT = 'INPUT'
    VALOR_TIPO_INFRA_TRANS_RODOV = 'VALOR_TIPO_INFRA_TRANS_RODOV'
    ...
    def initAlgorithm(self, config=None):
        ...
        self.vtitr_keys, self.vtitr_values = get_lista_codigos('valorTipoInfraTransRodov')
        self.addParameter(
            QgsProcessingParameterEnum(
                self.VALOR_TIPO_INFRA_TRANS_RODOV,
                self.tr('Valor Tipo Infra Trans Rodov'),
                self.vtitr_keys,
                defaultValue=0,
                optional=False,
            )
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        valor_tipo_infra_trans_rodov = self.vtitr_values[
        ...
        alg_params = {
            'FIELDS_MAPPING': [{
                ...
                'expression': valor_tipo_infra_trans_rodov,
                'length': 255,
                'name': 'valor_tipo_infra_trans_rodov',
                'precision': -1,
                'type': 10
            }],
    ...
    def name(self):
        return 'exportar_infra_trans_rodov'

    def displayName(self):
        return '13. Exportar Infraestrutura de transporte rodoviário'
    ...
    def createInstance(self):
        return ExportarInfraTransRodov()
    ...
    def shortHelpString(self):
        return self.tr("Exporta elementos do tipo Infraestrutura de transporte rodoviário para a base " \
