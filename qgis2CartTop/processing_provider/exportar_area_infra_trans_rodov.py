...
class ExportarAreaInfraTransRodov(QgsProcessingAlgorithm):
    ...
    INPUT = 'INPUT'
    CAMPO_COM_INFRA_TRANS_RODOV_ID = 'CAMPO_COM_INFRA_TRANS_RODOV_ID'
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(
            QgsProcessingParameterField(
                self.CAMPO_COM_INFRA_TRANS_RODOV_ID,
                self.tr(' Campo com ID da Infraestrutura de Transporte Rodoviário'),
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        campo_com_infra_trans_rodov_id = self.parameterAsString(
            parameters,
            self.CAMPO_COM_INFRA_TRANS_RODOV_ID,
            context
        )
        ...
        alg_params = {
            'FIELDS_MAPPING': [{
                ...
                'expression': f'\"{campo_com_infra_trans_rodov_id}\"',
                'length': 255,
    ...
    def name(self):
        return 'exportar_area_infra_trans_rodov'

    def displayName(self):
        return '12. Exportar Área da infraestrutura de transporte rodoviário'
    ...
    def createInstance(self):
        return ExportarAreaInfraTransRodov()
    ...
    def shortHelpString(self):
        return self.tr("Exporta elementos do tipo Área da infraestrutura de transporte rodoviário para a base " \
                       "de dados RECART usando uma ligação PostgreSQL/PostGIS " \
                       "já configurada.\n\n" \
                       "A camada vectorial de input deve ser do tipo polígono 2D e deve conter um campo com o id "\
                       "da respectiva Infraestrutura de transporte rodoviário"
        )