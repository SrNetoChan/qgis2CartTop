...
class ExportarViaRodovLimite(QgsProcessingAlgorithm):
    ...
    INPUT = 'INPUT'
    VALOR_TIPO_LIMITE = 'VALOR_TIPO_LIMITE'
    ...
    def initAlgorithm(self, config=None):
        ...
        self.vtl_keys, self.vtl_values = get_lista_codigos('valorTipoLimite')
        self.addParameter(
            QgsProcessingParameterEnum(
                self.VALOR_TIPO_LIMITE,
                self.tr('Valor Tipo Limite'),
                self.vtl_keys,
                defaultValue=0,
                optional=False,
            )
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        valor_tipo_limite = self.vtl_values[
    ...
    def name(self):
        return 'exportar_via_rodov_limite'

    def displayName(self):
        return '16. Exportar Via rodoviária - Limite'
    ...
    def shortHelpString(self):
        return self.tr("Exporta elementos do tipo Via rodoviária - Limite para a base " \
